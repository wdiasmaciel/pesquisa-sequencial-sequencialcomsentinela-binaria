...
public class MainPesquisaBinaria {
    public static void main(String[] args) {
        ...
        //A pesquisa binária só funciona apropriadamente se o vetor estiver ordenado.
        Arrays.sort(vetor);
        ...
        pos = pesquisa.binaria(vetor, elemento, 0, vetor.length - 1);
        if (pos >= 0)
